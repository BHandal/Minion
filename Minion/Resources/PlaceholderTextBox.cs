...
namespace Demo
{
	...
	public sealed class PlaceholderTextBox : TextBox
	{
		...
		public string _placeholderText = DEFAULT_PLACEHOLDER;
		public bool _isItalics = true;
		public bool _isPlaceholderActive;
		...
		public void ActionWithoutTextChanged(Action act)
		{
		...
		/// </summary>
		public void AssignPlaceholderStyle()
		{
		...
		/// </summary>
		public void RemovePlaceholderStyle()
		{
		...
		public void PlaceholderTextBox_TextChanged(object sender, EventArgs e)
		{
			// Check flag
			if (avoidTextChanged)
				return;
